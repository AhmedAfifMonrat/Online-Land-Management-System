...
$output = str_replace($bn_digits,range(0, 9), $rent);
$rent_eng=$output;
$output = str_replace($bn_digits,range(0, 9), $t_rent);
$t_rent_eng=$output;
$output = str_replace($bn_digits,range(0, 9), $vat);
$vat_eng=$output;
$output = str_replace($bn_digits,range(0, 9), $tax);
$tax_eng=$output;
$output = str_replace($bn_digits,range(0, 9), $plge);
$plge_eng=$output;
$output = str_replace($bn_digits,range(0, 9), $t_amount);
$t_amount_eng=$output;
...
$result=mysql_query($sql,$con);
 while($row = mysql_fetch_array($result)) {
			...
			mysql_select_db($database,$con);
            $sql="insert into $tab_name                    values('$rs','$rent_eng','$t_rent_eng','$vat_eng','$tax_eng','','$plge_eng','','','$t_amount_eng','','$year')";
			mysql_query($sql,$con);
			}
...
<tr>
<td>খাজনার হার :</td>
<td><?php echo $rent." টাকা প্রতি শতক/বর্গফুট "; ?> </td>
</tr>
<tr>
<td>মোট খাজনা :</td>
<td><?php echo $t_rent." টাকা"; ?></td>
</tr>
<tr>
<td>ভেট (১৫%) :</td>
<td><?php echo $vat." টাকা"; ?></td>
</tr>
<tr>
<td>আয়কর (৫%) :</td>
<td><?php echo $tax." টাকা"; ?></td>
</tr>
<tr>
...
<button type="button" id="btn" value="<?php echo $r_s_rights; ?>" style="margin-top:10px; background-color:#FF3300; color:#FFFFFF; height:30px; cursor:pointer" onclick="issue_letter(this.value)">Issue Lease Letter</button>
</body>
</html>
